// Palindrome (палиндром) - это слово, фраза или последовательность символов, которая одинаково читается как в прямом,
// так и в обратном направлении.Задача palindrome на собеседованиях по JavaScript заключается в написании программы,
// которая проверяет, является ли заданное слово или фраза палиндромом.
